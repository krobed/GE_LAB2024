...
phen, tree_depth, other_info, quality, quality_val,opt_const = 'x[0]**Constant + Constant*x[1]**Constant', None, None, np.inf, np.inf, []
ind = [[0],[0],[2,0],[3,2,2,3],[1,2,1],[3,2,0,0,0,3,2,1],[1,1,0,0,1,1,1],[1,0,0]]
